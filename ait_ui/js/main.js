...
const socketEvents = {
    'download-pdf': (data) => {
        ...
        // Add the logo (replace 'logoSrc' with the URL of your logo image)
        const logoSrc = 'AIT_White.png'; // URL to the logo image
        const logoWidth = 100;
        const logoHeight = 50;
        const logoX = 220 + doc.getTextWidth('Certificated By'); // Adjust the X-coordinate to position the logo next to the text
        const logoY = 270; // Keep it on the same line
        ...
        const yCoordinate = 370; // Replace with your desired Y coordinate
